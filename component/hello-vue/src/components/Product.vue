...
export default {
      ...
      variants: [
        {
          ...
          variantId: 2234,
          variantColor: "green",
          variantImage: require("@/assets/images/socks_green.jpg"), // import할때도 같은 폴더 안에 ./을 쓰는데 @를 써도 된다.
  ...
  computed: {
    // 캐싱을 한다. 처음에만 값을 계산해서 저장하고 값이 변하지 않는 이상 다시 계산하지 않고 기존에 저장된 값을 리턴한다. this.참조하는 변수가 있을 때만 사용. 매번 호출할 때마다 새로운 값이 나올 때는 함수를 사용하자.
    title() {
